...
(	
	...
	NOTE TEXT(4000),
	DENOMINAZIONE_PROVINCIA TEXT(300)
);

CREATE TABLE WP1_TOPONIMI_DA_REV_HISTORY
(	
    PROGRESSIVO_TOPONIMO INT,
    CODICE_ARCHIVIO INT(3),
    PRO_COM TEXT(6),
    DENOMINAZIONE_COMUNE TEXT(300),
    CDPSTR_RSBL DOUBLE,
	LOCALITA_ORIG TEXT(300),
    DUG_ORIG TEXT(300),
    DUF_ORIG TEXT(300),   
    CDPSTR_PROB DOUBLE,
    LOCALITA_PROB  TEXT(300),
    DUG_PROB  TEXT(300), 
    DUF_PROB  TEXT(300),    
    VALIDAZIONE TEXT(2),   
	LOCALITA_VAL TEXT(300),
    DUG_VAL TEXT(300),
    DUF_VAL TEXT(300),
	CDPSTR_VAL INT(12),    
    DNC TEXT(15), 
    ...
    TM TEXT(15),
    WMAX TEXT(15),
    FALSI_POSITIVI TEXT(15),
    FALSI_NEGATIVI TEXT(15),
    FLAG_VERIFICA INT,    
    ID_REVISORE INT(3), 
	STATO INT(3),
	DATA_INS DATE, 
