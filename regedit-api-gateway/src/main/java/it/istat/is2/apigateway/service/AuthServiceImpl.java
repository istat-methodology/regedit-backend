...
public class AuthServiceImpl implements AuthService
{
    ...
    @Autowired
    public AuthServiceImpl(PasswordEncoder passwordEncoder, JwtTokenProvider jwtTokenProvider, AuthenticationManager authenticationManager, UserRespository userRepository, JwtTokenRepository jwtTokenRepository) {
